...
class SystemScreen(BaseScreen):
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        try:
            ...
            disk_percent = 0
            disk_text = "N/A"
        self.ui.draw_chunky_bar(surface, 60, y, 336, 22, disk_percent, colors.GRAY())
        ...
        # Temperature box
        self.ui.draw_pixel_border(surface, pygame.Rect(15, y, 220, 50), colors.ORANGE())
        ...
        # Uptime box
        self.ui.draw_pixel_border(surface, pygame.Rect(15, y, 220, 50), colors.GREEN())
        ...
        # Fan box
        self.ui.draw_pixel_border(surface, pygame.Rect(250, y, 220, 50), colors.YELLOW())
